            ...
            <tbody>
                <?php while ($row = mysqli_fetch_array($query)): ?>
                    <tr>
                        ...
                        <th><a href="actualizarmysql.php?dpi=<?= $row['dpi'] ?>" class="ussers-table--edit">Editar</a></th>
                        <th><a href="borrarmysql.php?dpi=<?= $row['dpi'] ?>" class="users-table--delete">Eliminar</a></th>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
